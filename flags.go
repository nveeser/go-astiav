...
// Flags is a generic function to build flag values of type F
// from individual flags using the binary or (|) operator.
// Used to handle the existing NewFooFlags API functions.
...
type (
	...
	// DispositionFlags is an alias for DispositionFlag
	// Deprecated - use DispositionFlag directly
	DispositionFlags = DispositionFlag
	// DictionaryFlags is an alias for DictionaryFlag
	// Deprecated - use DictionaryFlag directly
	DictionaryFlags = DictionaryFlag
	// ErrorRecognitionFlags is an alias for ErrorRecognitionFlag
	// Deprecated - use ErrorRecognitionFlag directly
	ErrorRecognitionFlags = ErrorRecognitionFlag
...
var (
	...
	NewDispositionFlags               = Flags[DispositionFlag]
	NewDictionaryFlags                = Flags[DictionaryFlag]
	NewErrorRecognitionFlags          = Flags[ErrorRecognitionFlag]
