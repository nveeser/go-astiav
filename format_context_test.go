...
func TestFormatContext(t *testing.T) {
	...
	t.Run("SDPCreate", func(t *testing.T) {
	...
	t.Run("SetLogCallback", func(t *testing.T) {
	...
	t.Run("FindBestStream", func(t *testing.T) {
	...
	t.Run("ReadFrame", func(t *testing.T) {
		...
		defer fc8.Free()
		require.NoError(t, fc8.OpenInput("testdata/video.mp4", nil, nil))
